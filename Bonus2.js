...
var unhappyVICTIMname = (prompt("Enter the name of the victim: "));
var unhappyVICTIMindex = victim_name.indexOf(unhappyVICTIMname);
var unhappyVICTIMstreet = victim_street[unhappyVICTIMindex];
var localvolunteers = new Array();
for (var i=0; i<nvols; i++) {
	if (vol_street[i] === unhapppyVICTIMstreet)
	localvolunteers.push(vol_name[i]); 
	}

}

alert("Here are the volunteers nearby: " + localvolunteers)
